 ...
 * WORKING VERSION - Currently live on site
 *
 * Handles AI search loading with engaging, search-specific progress updates
 * Version: 2.0 (Simplified - No form conflict workarounds needed)
 */
...
(function() {
   ...
   *
   * IMPORTANT: Only binds to dual-search-form if it exists.
   * Since we're using a non-form snippet (div instead of form),
   * this prevents interference with other header/theme search forms.
   */
